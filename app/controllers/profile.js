  ...
  .directive('d3Gauge', function() {
    ...
    return {
      ...
      link: function(scope, elem, attrs) {
        ...
        elem.append('<svg id=' + uniqid + '  width="100%" height="100%"></svg>');

        var value = (!attrs.value)? 50 : Number(attrs.value);
        ...
        var gaugeOptions = {
          ...
          circleColor: (!attrs.circleColor)? "#178BCA" : attrs.circleColor, // The color of the outer circle.
          ...
          waveColor: (!attrs.waveColor)? "#178BCA" : attrs.waveColor, // The color of the fill wave.
          waveOffset: 0, // The amount to initially offset the wave. 0 = no offset. 1 = offset of one full wave.
          textVertPosition: .5, // The height at which to display the percentage text withing the wave circle. 0 = bottom, 1 = top.
          textSize: 1, // The relative height of the text to display in the wave circle. 1 = 50%
          valueCountUp: true, // If true, the displayed value counts up from 0 to it's final value upon loading. If false, the final value is displayed.
          displayPercent: true, // If true, a % symbol is displayed after the value.
          textColor: (!attrs.textColor)? "#178BCA" : attrs.textColor, // The color of the value text when the wave does not overlap it.
          waveTextColor: (!attrs.waveTextColor)? "#A4DBf8" : attrs.waveTextColor // The color of the value text when the wave overlaps it.
        };



        loadLiquidFillGauge(uniqid, value, gaugeOptions);
